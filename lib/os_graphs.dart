...
class OxygenSaturationGraphs extends StatelessWidget {
  ...
  var osController = TextEditingController();
      ...
      body: Column(
        children: [
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    child: const Text('Would you like to connect to a pulse oximeter?', style: TextStyle(
                                    fontSize: 20,
                                  ),),
                                      ...
                                      ElevatedButton(
                                        ...
                                        builder: (BuildContext context) {
                                          return Container(
                                              ...
                                              children: <Widget>[
                                                Container(
                                                  child: Text('Oxygen Saturation', style: TextStyle(
                                                    fontSize: 20,
                                                  ),),
                                                ...
                                                Container(
                                                  child: ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      List myList = [{
                                                        'OS': int.parse(osController.text.trim()),
                ...
                if (!snapshot.hasData) {
                  ...
                  return ListView(
                    children: snapshot.data!.docs.map((doc) {
                      ...
                      //print(arrayLength);
                      var bpTimeList = List.generate(arrayLength, (i) => List.filled(3, '', growable: false), growable: false);
                      var graphBPList = List.generate(7, (i) => List.filled(3, '', growable: false), growable: false);
                      outerLoop:
                      for (int i = 0; i < arrayLength; i++) {
                        ...
                        bpTimeList[i][2] = doc['Data'][i]['OS'].toString();
          ...
          Container(
            ...
            child: Text("Today's Oxygen Saturation Data", style: TextStyle(
              fontSize: 20,
                      ...
                      children: snapshot.data!.docs.map((doc) {
                        ...
                        for (int i = 0; i < arrayLength2; i++) {
                          ...
                          if (checkDate4 == todayDate) {
                            hearts.add(heart(os: os, date: checkDate4));
                            x = x + 1;
                          }
                        }
                        return Container(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => Card(
                              child: ListTile(
                                leading: Icon(
                                  Icons.bubble_chart_outlined, color: Color.fromRGBO(240, 172, 159, 1.0), size: 40,),
                                title: Text("${hearts[index].os}%"),
